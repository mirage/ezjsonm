...
(* OASIS_START *)
(* DO NOT EDIT (digest: 68cca6568047b85cfbb2f5b8a11af479) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ezjsonm", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ezjsonm", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the support for Lwt streams";
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("jsonm", None)];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ezjsonm_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ezjsonm";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "¦\007\021\159láÈ\011ð»Û\020\151\152¾Ä";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
