...
(* OASIS_START *)
(* DO NOT EDIT (digest: a40da88188b603b3356178976aec48fb) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\176\192\232-g\2551\029\222(i\219\236\239\138\184";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
